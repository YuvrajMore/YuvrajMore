...
- Employed as fullstack developer since 1+ year, working in US healthcare domain.
- Mostly I work on C#, .Net web API, MVC, Bland AI IVR Tool, SQL Server and sometimes on nodeJS, power BI and Angular.
- Implented various small/large features based on client/internal requests, improved success rate of AI agent IVR Calls.
...
- Containerization and cluster management - probably docker or kubernetes
